   ...
   --Ek ürün seçme seçeneği olsun, siz devam ettiğiniz sürece,
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        do {
            ...
            if (banknot == 1 || banknot == 5 || banknot == 10 || banknot == 20) {
                ...
                if (odemeTutari<toplamTutar){
                    System.out.println("-------------------------------------------------------------");
                    System.out.println("Lutfen odemeyi tam yapiniz, odemeniz gereken eksik tutar --> "+(toplamTutar-odemeTutari));
                    System.out.println("-------------------------------------------------------------\n");
                ...
                System.out.println("Otomatimiz sadece $1,$5,$10,$20'lik banknot kabul etmektedir. Lutfen odemeyi bu sekilde yapiniz..\n");
        ...
        if (odemeTutari>toplamTutar){
            ...
            System.out.println("Bizi tercih ettiginiz icin tesekkur ederiz gorusmek uzere :)");
